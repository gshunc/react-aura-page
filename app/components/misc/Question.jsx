export default function Question(props) {
  ...
  return (
    <main className="flex flex-col relative">
      ...
      <div className="hidden w-48 p-4 peer-hover:inline absolute top-9 self-center bg-gray-200 border-2 border-blue-900 rounded-md font-light text-sm text-center">
        {content}
      </div>
    </main>
  );
