...
export default function AnalyticsClient({
  ...
  const onChange = async (newDate) => {
    ...
    setDate(utcDate);
    const newData = await onDateChange(utcDate);
    setData(newData);
  };
  ...
  return (
    <main className="flex min-h-screen flex-col mb-5">
      ...
      <div className="ml-10">
        <DateComponent date={date} onChange={onChange} />
      </div>
      <div className="flex flex-row justify-around">
        <div className="flex flex-col space-y-5 mt-5">
          <GraphBox
            ...
            content={
              <StepBar
                unformattedData={data.profileData}
          ...
          <GraphBox
            title={"Active Time"}
            content={<ActivityBar unformattedData={data.profileData} />}
          ...
          <GraphBox
            ...
            content={
              <AlexaInteractionsGraph
                unformattedData={data.alexaData}
                userid={userid}
              />
            }
